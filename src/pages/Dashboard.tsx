...
const samplePlans = [
  {
    ...
    description: "Heart-healthy Mediterranean lifestyle with olive oil, fresh fish, and vibrant vegetables",
    duration: "4 weeks",
    difficulty: "Easy" as const,
    meals: ["Greek Salad with Feta", "Grilled Salmon", "Quinoa Tabbouleh", "Hummus & Olives"],
    calories: 1800,
  },
  {
    id: "2", 
    name: "HIGH PROTEIN PLAN",
    description: "Muscle-building powerhouse with lean proteins and recovery-focused nutrition",
    duration: "6 weeks",
    difficulty: "Medium" as const,
    meals: ["Protein Power Bowl", "Grilled Chicken", "Lean Beef & Quinoa", "Greek Yogurt Parfait"],
    calories: 2200,
  },
  {
    id: "3",
    name: "KETO LIFESTYLE", 
    description: "Low-carb, high-fat ketogenic approach for metabolic transformation",
    duration: "8 weeks",
    difficulty: "Hard" as const,
    meals: ["Avocado & Eggs", "Keto Salmon", "Cauliflower Mash", "MCT Oil Smoothie"],
    calories: 1600,
  }
];
